...
class Ticket:
    def __init__(self, id=0, user_id=0, film_id=0, hall_id=0, date="", time="", row=0, seat=0, price=0):
        self.id = id
        ...
        self.seat = seat
        self.price = price
        self.payment_link = "https://tbank.spv/Love"
...
class Cinema:
    ...
    def init_test_data(self):
        films_data = [
            ["Аватар", "avatar.jpg", "фантастика", "премьера", "15.03-30.03"],
            ["Оно", "ono.jpg", "ужасы", "летнее", "01.06-15.06"],
            ["Дюна", "dune.jpg", "фантастика", "премьера", "10.03-25.03"],
            ["Чебурашка", "cheb.jpg", "комедия", "к 14 февраля", "10.02-20.02"],
            ["Драйв", "drive.jpg", "триллер", "премьера", "20.03-05.04"],
            ["Барби", "barbie.jpg", "комедия", "летнее", "01.07-15.07"],
            ["Крик", "krik.jpg", "ужасы", "хэллоуин", "25.10-05.11"],
